 ...
 * issueId, issueSolved, issueMessage: issue information. Transactions can:
   ...
   * Contain a list of issues: in this case, the transaction information will be repeated in different entries in `transactions.json` 
   changing the issue related information.
